 ...
 * The demo library.
 *
 * Seeded on first visit, because an empty library is a broken demo: a judge
 * with cold storage would ask "what should I read next?" and get an honest
 * "not enough history yet" — the flagship journey producing nothing for the
 * one person who matters. See docs/07-risks.md, R2.
 *
